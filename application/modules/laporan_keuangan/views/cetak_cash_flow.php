	...
	<body>
		...
		<?php
			...
			<tr class="table-total">
				...
				<th align="right"><?php echo number_format(($total_rap_nilai_2022 - $jumlah_termin) - ($total_biaya_rap_2022_biaya - $jumlah_biaya_bank + $jumlah_persiapan + $jumlah_bua),0,',','.');?></th>
			</tr>
			<tr class="table-baris1">

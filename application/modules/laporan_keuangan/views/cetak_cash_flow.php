	...
	<body>
		...
		<?php
			...
			<tr class="table-judul">
				...
				<th width="6%" align="center"><div style="text-transform:uppercase;">SD. <?php echo $date_3_awal=date('F', strtotime('+1 days', strtotime($date_2_akhir)));?></div></th>
				<th width="6%" align="center"><div style="text-transform:uppercase;"><?php echo $date_4_awal=date('F', strtotime('+1 days', strtotime($date_3_akhir)));?></div></th>
				<th width="6%" align="center"><div style="text-transform:uppercase;">SD. <?php echo $date_4_awal=date('F', strtotime('+1 days', strtotime($date_3_akhir)));?></div></th>
				<th width="6%" align="center"><div style="text-transform:uppercase;"><?php echo $date_5_awal=date('F', strtotime('+1 days', strtotime($date_4_akhir)));?></div></th>
				<th width="6%" align="center"><div style="text-transform:uppercase;">SD. <?php echo $date_5_awal=date('F', strtotime('+1 days', strtotime($date_4_akhir)));?></div></th>
				<th width="6%" align="center"><div style="text-transform:uppercase;"><?php echo $date_6_awal=date('F', strtotime('+1 days', strtotime($date_5_akhir)));?></div></th>
				<th width="6%" align="center"><div style="text-transform:uppercase;">SD. <?php echo $date_6_awal=date('F', strtotime('+1 days', strtotime($date_5_akhir)));?></div></th>
				<th width="6%" align="center" rowspan="2">&nbsp; <br />SISA</th>
	        </tr>
			<tr class="table-judul">
				<th align="center">CASH BUDGET</th>
				<th align="center"><?php echo $date_1_awal = date('Y');?></th>
				<th align="center"><?php echo $date_1_awal = date('Y');?></th>
				<th align="center"><?php echo $date_2_awal = date('Y', strtotime('+1 days', strtotime($date_1_akhir)));?></th>
				<th align="center"><?php echo $date_2_awal = date('Y', strtotime('+1 days', strtotime($date_1_akhir)));?></th>
				<th align="center"><?php echo $date_3_awal = date('Y', strtotime('+1 days', strtotime($date_2_akhir)));?></th>
				<th align="center"><?php echo $date_3_awal = date('Y', strtotime('+1 days', strtotime($date_2_akhir)));?></th>
				<th align="center"><?php echo $date_4_awal = date('Y', strtotime('+1 days', strtotime($date_3_akhir)));?></th>
				<th align="center"><?php echo $date_4_awal = date('Y', strtotime('+1 days', strtotime($date_3_akhir)));?></th>
				<th align="center"><?php echo $date_5_awal = date('Y', strtotime('+1 days', strtotime($date_4_akhir)));?></th>
				<th align="center"><?php echo $date_5_awal = date('Y', strtotime('+1 days', strtotime($date_4_akhir)));?></th>
				<th align="center"><?php echo $date_6_awal = date('Y', strtotime('+1 days', strtotime($date_5_akhir)));?></th>
				<th align="center"><?php echo $date_6_awal = date('Y', strtotime('+1 days', strtotime($date_5_akhir)));?></th>
	        </tr>
			<?php
			//PRESENTASE
			...
			<tr class="table-baris1">
				...
				<th align="left" colspan="16"><u>PRODUKSI (EXCL. PPN)</u></th>
			</tr>
			<tr class="table-baris1">
				<th align="left"><u>AKUMULASI %</u></th>
				<th align="right">100%</th>
				<th align="right"><?php echo number_format($presentase_now,0,',','.');?>%</th>
				<th align="right"><?php echo number_format($presentase_1,0,',','.');?>%</th>
				<th align="right"><?php echo number_format($presentase_akumulasi_1,0,',','.');?>%</th>
				<th align="right"><?php echo number_format($presentase_2,0,',','.');?>%</th>
				<th align="right"><?php echo number_format($presentase_akumulasi_2,0,',','.');?>%</th>
				<th align="right"><?php echo number_format($presentase_3,0,',','.');?>%</th>
				<th align="right"><?php echo number_format($presentase_akumulasi_3,0,',','.');?>%</th>
				<th align="right"><?php echo number_format($presentase_4,0,',','.');?>%</th>
				<th align="right"><?php echo number_format($presentase_akumulasi_4,0,',','.');?>%</th>
				<th align="right"><?php echo number_format($presentase_5,0,',','.');?>%</th>
				<th align="right"><?php echo number_format($presentase_akumulasi_5,0,',','.');?>%</th>
				<th align="right"><?php echo number_format($presentase_6,0,',','.');?>%</th>
				<th align="right"><?php echo number_format($presentase_akumulasi_6,0,',','.');?>%</th>
				<th align="right"><?php echo number_format(100 - $total_presentase,0,',','.');?>%</th>
			</tr>
			<tr class="table-total">
				<th align="left">&nbsp;&nbsp;1. Produksi / Penjualan</th>
				...
				<th align="right"><?php echo number_format($akumulasi_penjualan_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($total_2_nilai,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_penjualan_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($total_3_nilai,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_penjualan_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($total_4_nilai,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_penjualan_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($total_5_nilai,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_penjualan_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($total_6_nilai,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_penjualan_6,0,',','.');?></th>
				<th align="right"><?php echo number_format($total_rap_nilai_2022 - $total_produksi,0,',','.');?></th>
			</tr>
			<tr class="table-baris1">
				<th align="center" rowspan="4" style="vertical-align:middle">II</th>
				<th align="left" colspan="16"><u>PENERIMAAN (EXCL. PPN)</u></th>
			</tr>
			<tr class="table-baris1">
				<th align="left">&nbsp;&nbsp;2.1 Tagihan (Realisasi)</th>
				<th align="right"><?php echo number_format($total_rap_nilai_2022,0,',','.');?></th>
				<th align="right"><?php echo number_format($termin_now['total'],0,',','.');?></th>
				<th align="right"><?php echo number_format($termin_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_termin_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($termin_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_termin_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($termin_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_termin_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($termin_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_termin_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($termin_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_termin_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($termin_6,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_termin_6,0,',','.');?></th>
				<th align="right"><?php echo number_format($total_rap_nilai_2022 - $jumlah_termin,0,',','.');?></th>
			</tr>
			<tr class="table-baris1">
				<th align="left">&nbsp;&nbsp;2.2 PPN (Keluaran)</th>
				<th align="right"><?php echo number_format($ppn_keluaran_rap,0,',','.');?></th>
				<th align="right"><?php echo number_format($ppn_keluar_now['total'],0,',','.');?></th>
				<th align="right"><?php echo number_format($ppn_keluaran_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_ppn_keluaran_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($ppn_keluaran_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_ppn_keluaran_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($ppn_keluaran_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_ppn_keluaran_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($ppn_keluaran_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_ppn_keluaran_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($ppn_keluaran_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_ppn_keluaran_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($ppn_keluaran_6,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_ppn_keluaran_6,0,',','.');?></th>
				<th align="right"><?php echo number_format($ppn_keluaran_rap - $jumlah_ppn_keluaran,0,',','.');?></th>
			</tr>
			<tr class="table-total">
				<th align="left">JUMLAH PENERIMAAN</th>
				<th align="right"><?php echo number_format($total_rap_nilai_2022 + $ppn_keluaran_rap,0,',','.');?></th>
				<th align="right"><?php echo number_format($termin_now['total'] + $ppn_keluar_now['total'],0,',','.');?></th>
				<th align="right"><?php echo number_format($termin_1 + $ppn_keluaran_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_termin_1 + $akumulasi_ppn_keluaran_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($termin_2 + $ppn_keluaran_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_termin_2 + $akumulasi_ppn_keluaran_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($termin_3 + $ppn_keluaran_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_termin_3 + $akumulasi_ppn_keluaran_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($termin_4 + $ppn_keluaran_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_termin_4 + $akumulasi_ppn_keluaran_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($termin_5 + $ppn_keluaran_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_termin_5 + $akumulasi_ppn_keluaran_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($termin_6 + $ppn_keluaran_6,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_termin_6 + $akumulasi_ppn_keluaran_6,0,',','.');?></th>
				<th align="right"><?php echo number_format(($total_rap_nilai_2022 - $jumlah_termin) + ($ppn_keluaran_rap - $jumlah_ppn_keluaran),0,',','.');?></th>
			</tr>
			<tr class="table-baris1">
				<th align="center" rowspan="8" style="vertical-align:middle">III</th>
				<th align="left" colspan="16"><u>PENGELUARAN (EXCL. PPN)</u></th>
			</tr>
			<tr class="table-baris1">
				<th align="left">&nbsp;&nbsp;3.1 Biaya Bahan</th>
				...
				<th align="right"><?php echo number_format($biaya_bahan_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_biaya_bahan_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($biaya_bahan_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_biaya_bahan_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($biaya_bahan_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_biaya_bahan_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($biaya_bahan_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_biaya_bahan_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($biaya_bahan_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_biaya_bahan_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($biaya_bahan_6,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_biaya_bahan_6,0,',','.');?></th>
				<th align="right"><?php echo number_format($total_rap_2022_biaya_bahan - $jumlah_biaya_bahan,0,',','.');?></th>
			</tr>
			<tr class="table-baris1">
				<th align="left">&nbsp;&nbsp;3.2 Biaya Alat</th>
				<th align="right"><?php echo number_format($total_rap_2022_biaya_alat,0,',','.');?></th>
				<th align="right"><?php echo number_format($alat_now,0,',','.');?></th>
				<th align="right"><?php echo number_format($biaya_alat_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_biaya_alat_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($biaya_alat_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_biaya_alat_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($biaya_alat_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_biaya_alat_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($biaya_alat_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_biaya_alat_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($biaya_alat_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_biaya_alat_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($biaya_alat_6,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_biaya_alat_6,0,',','.');?></th>
				<th align="right"><?php echo number_format($total_rap_2022_biaya_alat - $jumlah_biaya_alat,0,',','.');?></th>
			</tr>
			<tr class="table-baris1">
				<th align="left">&nbsp;&nbsp;3.3 Biaya Bank</th>
				...
				<th align="right"><?php echo number_format($biaya_bank_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_biaya_bank_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($biaya_bank_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_biaya_bank_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($biaya_bank_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_biaya_bank_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($biaya_bank_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_biaya_bank_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($biaya_bank_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_biaya_bank_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($biaya_bank_6,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_biaya_bank_6,0,',','.');?></th>
				<th align="right"><?php echo number_format($total_rap_2022_biaya_bank - $jumlah_biaya_bank,0,',','.');?></th>
			</tr>
			<tr class="table-baris1">
				<th align="left">&nbsp;&nbsp;3.4 BUA</th>
				...
				<th align="right"><?php echo number_format($biaya_overhead_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_biaya_overhead_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($biaya_overhead_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_biaya_overhead_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($biaya_overhead_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_biaya_overhead_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($biaya_overhead_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_biaya_overhead_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($biaya_overhead_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_biaya_overhead_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($biaya_overhead_6,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_biaya_overhead_6,0,',','.');?></th>
				<th align="right"><?php echo number_format($total_rap_2022_biaya_overhead - $jumlah_biaya_overhead,0,',','.');?></th>
			</tr>
			<tr class="table-baris1">
				<th align="left">&nbsp;&nbsp;3.5 PPN Rekanan</th>
				...
				<th align="right"><?php echo number_format($ppn_keluaran_6,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_ppn_keluaran_6,0,',','.');?></th>
				<th align="right"><?php echo number_format($pajak_masukan - $jumlah_ppn_keluaran,0,',','.');?></th>
			</tr>
			<tr class="table-baris1">
				<th align="left">&nbsp;&nbsp;3.6 Biaya Persiapan</th>
				<th align="right"><?php echo number_format($total_rap_2022_biaya_persiapan,0,',','.');?></th>
				<th align="right"><?php echo number_format($biaya_persiapan_now['total'],0,',','.');?></th>
				<th align="right"><?php echo number_format($biaya_persiapan_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_biaya_persiapan_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($biaya_persiapan_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_biaya_persiapan_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($biaya_persiapan_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_biaya_persiapan_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($biaya_persiapan_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_biaya_persiapan_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($biaya_persiapan_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_biaya_persiapan_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($biaya_persiapan_6,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_biaya_persiapan_6,0,',','.');?></th>
				<th align="right"><?php echo $sisa_biaya_persiapan < 0 ? "(".number_format($sisa_biaya_persiapan,0,',','.').")" : number_format($sisa_biaya_persiapan,0,',','.');?></th>
			</tr>
			<tr class="table-total">
				<th align="left">JUMLAH PENGELUARAN</th>
				<th align="right"><?php echo number_format($jumlah_pengeluaran,0,',','.');?></th>
				<th align="right"><?php echo number_format($jumlah_pengeluaran_now,0,',','.');?></th>
				<th align="right"><?php echo number_format($jumlah_pengeluaran_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pengeluaran_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($jumlah_pengeluaran_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pengeluaran_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($jumlah_pengeluaran_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pengeluaran_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($jumlah_pengeluaran_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pengeluaran_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($jumlah_pengeluaran_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pengeluaran_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($jumlah_pengeluaran_6,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pengeluaran_6,0,',','.');?></th>
				<th align="right"><?php echo number_format($jumlah_pengeluaran - $total_pengeluaran,0,',','.');?></th>
			</tr>
			<tr class="table-baris1">
				<th align="center" rowspan="4" style="vertical-align:middle">IV</th>
				<th align="left" colspan="16"><u>PAJAK</u></th>
			</tr>
			<tr class="table-baris1">
				<th align="left">&nbsp;&nbsp;1. Pajak Keluaran</th>
				<th align="right"><?php echo number_format($total_rap_2022_pajak_keluaran,0,',','.');?></th>
				<th align="right"><?php echo number_format($pajak_keluaran_now['total'],0,',','.');?></th>
				<th align="right"><?php echo number_format($pajak_keluaran_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pajak_keluaran_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($pajak_keluaran_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pajak_keluaran_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($pajak_keluaran_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pajak_keluaran_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($pajak_keluaran_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pajak_keluaran_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($pajak_keluaran_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pajak_keluaran_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($pajak_keluaran_6,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pajak_keluaran_6,0,',','.');?></th>
				<th align="right"><?php echo number_format($total_rap_2022_pajak_keluaran - $total_pajak_keluaran_6,0,',','.');?></th>
			</tr>
			<tr class="table-baris1">
				<th align="left">&nbsp;&nbsp;2. Pajak Masukan</th>
				<th align="right"><?php echo number_format($total_rap_2022_pajak_masukan,0,',','.');?></th>
				<th align="right"><?php echo number_format($pajak_masukan_now['total'],0,',','.');?></th>
				<th align="right"><?php echo number_format($pajak_masukan_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pajak_masukan_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($pajak_masukan_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pajak_masukan_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($pajak_masukan_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pajak_masukan_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($pajak_masukan_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pajak_masukan_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($pajak_masukan_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pajak_masukan_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($pajak_masukan_6,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pajak_masukan_6,0,',','.');?></th>
				<th align="right"><?php echo number_format($total_rap_2022_pajak_masukan - $total_pajak_masukan_6,0,',','.');?></th>
			</tr>
			<tr class="table-total">
				<th align="left">KURANG BAYAR PPN</th>
				<th align="right"><?php echo number_format($total_rap_2022_pajak_keluaran - $total_rap_2022_pajak_masukan,0,',','.');?></th>
				<th align="right"><?php echo number_format($pajak_keluaran_now['total'] - $pajak_masukan_now['total'],0,',','.');?></th>
				<th align="right"><?php echo number_format($pajak_keluaran_1 - $pajak_masukan_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pajak_keluaran_1 - $akumulasi_pajak_masukan_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($pajak_keluaran_2 - $pajak_masukan_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pajak_keluaran_2 - $akumulasi_pajak_masukan_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($pajak_keluaran_3 - $pajak_masukan_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pajak_keluaran_3 - $akumulasi_pajak_masukan_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($pajak_keluaran_4 - $pajak_masukan_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pajak_keluaran_4 - $akumulasi_pajak_masukan_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($pajak_keluaran_5 - $pajak_masukan_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pajak_keluaran_5 - $akumulasi_pajak_masukan_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($pajak_keluaran_6 - $pajak_masukan_6,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pajak_keluaran_6 - $akumulasi_pajak_masukan_6,0,',','.');?></th>
				<th align="right"><?php echo number_format(($total_rap_2022_pajak_keluaran - $total_pajak_keluaran_6) - ($total_rap_2022_pajak_masukan - $total_pajak_masukan_6),0,',','.');?></th>
			</tr>
			<tr class="table-baris1">
				<th align="center" rowspan="9" style="vertical-align:middle">V</th>
				<th align="left" colspan="16"><u>PINJAMAN</u></th>
			</tr>
			<tr class="table-baris1">
				<th align="left" colspan="16">MODAL PERSIAPAN</th>
			</tr>
			<tr class="table-baris1">
				<th align="left">&nbsp;&nbsp;1. Penerimaan Pinjaman</th>
				<th align="right"><?php echo number_format($total_rap_2022_penerimaan_pinjaman,0,',','.');?></th>
				<th align="right"><?php echo number_format($penerimaan_pinjaman_now,0,',','.');?></th>
				<th align="right"><?php echo number_format($penerimaan_pinjaman_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_penerimaan_pinjaman_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($penerimaan_pinjaman_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_penerimaan_pinjaman_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($penerimaan_pinjaman_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_penerimaan_pinjaman_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($penerimaan_pinjaman_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_penerimaan_pinjaman_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($penerimaan_pinjaman_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_penerimaan_pinjaman_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($penerimaan_pinjaman_6,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_penerimaan_pinjaman_6,0,',','.');?></th>
				<th align="right"><?php echo number_format($total_rap_2022_penerimaan_pinjaman - $total_penerimaan_pinjaman,0,',','.');?></th>
			</tr>
			<tr class="table-baris1">
				<th align="left">&nbsp;&nbsp;2. Pengembalian Pinjaman</th>
				<th align="right"><?php echo number_format($total_rap_2022_pengembalian_pinjaman,0,',','.');?></th>
				<th align="right"><?php echo number_format($pengembalian_pinjaman_now,0,',','.');?></th>
				<th align="right"><?php echo number_format($pengembalian_pinjaman_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pengembalian_pinjaman_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($pengembalian_pinjaman_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pengembalian_pinjaman_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($pengembalian_pinjaman_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pengembalian_pinjaman_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($pengembalian_pinjaman_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pengembalian_pinjaman_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($pengembalian_pinjaman_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pengembalian_pinjaman_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($pengembalian_pinjaman_6,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pengembalian_pinjaman_6,0,',','.');?></th>
				<th align="right"><?php echo number_format($total_rap_2022_pengembalian_pinjaman - $total_pengembalian_pinjaman,0,',','.');?></th>
			</tr>
			<tr class="table-total">
				<th align="left">SISA PINJAMAN DANA</th>
				<th align="right"><?php echo number_format($total_rap_2022_penerimaan_pinjaman - $total_rap_2022_pengembalian_pinjaman,0,',','.');?></th>
				<th align="right"><?php echo number_format($penerimaan_pinjaman_now - $pengembalian_pinjaman_now,0,',','.');?></th>
				<th align="right"><?php echo number_format($penerimaan_pinjaman_1 - $pengembalian_pinjaman_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_penerimaan_pinjaman_1 - $akumulasi_pengembalian_pinjaman_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($penerimaan_pinjaman_2 - $pengembalian_pinjaman_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_penerimaan_pinjaman_2 - $akumulasi_pengembalian_pinjaman_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($penerimaan_pinjaman_3 - $pengembalian_pinjaman_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_penerimaan_pinjaman_3 - $akumulasi_pengembalian_pinjaman_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($penerimaan_pinjaman_4 - $pengembalian_pinjaman_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_penerimaan_pinjaman_4 - $akumulasi_pengembalian_pinjaman_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($penerimaan_pinjaman_5 - $pengembalian_pinjaman_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_penerimaan_pinjaman_5 - $akumulasi_pengembalian_pinjaman_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($penerimaan_pinjaman_6 - $pengembalian_pinjaman_6,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_penerimaan_pinjaman_6 - $akumulasi_pengembalian_pinjaman_6,0,',','.');?></th>
				<th align="right"><?php echo number_format(($total_rap_2022_penerimaan_pinjaman - $total_penerimaan_pinjaman_6) - ($total_rap_2022_pengembalian_pinjaman - $total_pengembalian_pinjaman_6),0,',','.');?></th>
			</tr>
			<tr class="table-baris1">
				<th align="left" colspan="16">PEMAKAIAN DANA</th>
			</tr>
			<tr class="table-baris1">
				<th align="left">&nbsp;&nbsp;1. Pinjaman Dana</th>
				<th align="right"><?php echo number_format($total_rap_2022_pinjaman_dana,0,',','.');?></th>
				<th align="right"><?php echo number_format($pinjaman_dana_now,0,',','.');?></th>
				<th align="right"><?php echo number_format($pinjaman_dana_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pinjaman_dana_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($pinjaman_dana_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pinjaman_dana_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($pinjaman_dana_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pinjaman_dana_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($pinjaman_dana_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pinjaman_dana_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($pinjaman_dana_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pinjaman_dana_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($pinjaman_dana_6,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pinjaman_dana_6,0,',','.');?></th>
				<th align="right"><?php echo number_format(0,0,',','.');?></th>
			</tr>
			<tr class="table-baris1">
				<th align="left">&nbsp;&nbsp;2. Pengembalian Pinjaman</th>
				<th align="right"><?php echo number_format($total_rap_2022_pengembalian_pinjaman_dana,0,',','.');?></th>
				<th align="right"><?php echo number_format($pengembalian_pinjaman_dana_now,0,',','.');?></th>
				<th align="right"><?php echo number_format($pengembalian_pinjaman_dana_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pengembalian_pinjaman_dana_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($pengembalian_pinjaman_dana_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pengembalian_pinjaman_dana_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($pengembalian_pinjaman_dana_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pengembalian_pinjaman_dana_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($pengembalian_pinjaman_dana_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pengembalian_pinjaman_dana_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($pengembalian_pinjaman_dana_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pengembalian_pinjaman_dana_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($pengembalian_pinjaman_dana_6,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pengembalian_pinjaman_dana_6,0,',','.');?></th>
				<th align="right"><?php echo number_format(0,0,',','.');?></th>
			</tr>
			<tr class="table-total">
				<th align="left">JUMLAH PEMAKAIAN DANA</th>
				<th align="right"><?php echo number_format($total_rap_2022_pinjaman_dana - $total_rap_2022_pengembalian_pinjaman_dana,0,',','.');?></th>
				<th align="right"><?php echo number_format($pinjaman_dana_now - $pengembalian_pinjaman_dana_now,0,',','.');?></th>
				<th align="right"><?php echo number_format($pinjaman_dana_1 - $pengembalian_pinjaman_dana_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pinjaman_dana_1 - $akumulasi_pengembalian_pinjaman_dana_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($pinjaman_dana_2 - $pengembalian_pinjaman_dana_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pinjaman_dana_2 - $akumulasi_pengembalian_pinjaman_dana_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($pinjaman_dana_3 - $pengembalian_pinjaman_dana_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pinjaman_dana_3 - $akumulasi_pengembalian_pinjaman_dana_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($pinjaman_dana_4 - $pengembalian_pinjaman_dana_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pinjaman_dana_4 - $akumulasi_pengembalian_pinjaman_dana_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($pinjaman_dana_5 - $pengembalian_pinjaman_dana_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pinjaman_dana_5 - $akumulasi_pengembalian_pinjaman_dana_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($pinjaman_dana_6 - $pengembalian_pinjaman_dana_6,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_pinjaman_dana_6 - $akumulasi_pengembalian_pinjaman_dana_6,0,',','.');?></th>
				<th align="right"><?php echo number_format(($total_rap_2022_pinjaman_dana - $total_pinjaman_dana_6) - ($total_rap_2022_pengembalian_pinjaman_dana - $total_pengembalian_pinjaman_dana_6),0,',','.');?></th>
			</tr>
			<tr class="table-baris1">
				<th align="center">VI</th>
				<th align="left"><u>PIUTANG</u></th>
				<th align="right"><?php echo number_format($total_rap_2022_piutang,0,',','.');?></th>
				<th align="right"><?php echo number_format($piutang_now,0,',','.');?></th>
				<th align="right"><?php echo number_format($piutang_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_piutang_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($piutang_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_piutang_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($piutang_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_piutang_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($piutang_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_piutang_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($piutang_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_piutang_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($piutang_6,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_piutang_6,0,',','.');?></th>
				<th align="right"><?php echo number_format(0,0,',','.');?></th>
			</tr>
			<tr class="table-baris1">
				<th align="center">VII</th>
				<th align="left"><u>HUTANG</u></th>
				<th align="right"><?php echo number_format($total_rap_2022_hutang,0,',','.');?></th>
				<th align="right"><?php echo number_format($hutang_now,0,',','.');?></th>
				<th align="right"><?php echo number_format($hutang_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_hutang_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($hutang_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_hutang_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($hutang_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_hutang_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($hutang_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_hutang_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($hutang_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_hutang_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($hutang_6,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_hutang_6,0,',','.');?></th>
				<th align="right"><?php echo number_format(0,0,',','.');?></th>
			</tr>
			<tr class="table-baris1">
				<th align="center">VIII</th>
				<th align="left"><u>POSISI DANA</u></th>
				<th align="right"><?php echo $posisi_dana_rap < 0 ? "(".number_format($posisi_dana_rap,0,',','.').")" : number_format($posisi_dana_rap,0,',','.');?></th>
				<th align="right"><?php echo $posisi_dana_now < 0 ? "(".number_format($posisi_dana_now,0,',','.').")" : number_format($posisi_dana_now,0,',','.');?></th>
				<th align="right"><?php echo $posisi_dana_1 < 0 ? "(".number_format($posisi_dana_1,0,',','.').")" : number_format($posisi_dana_1,0,',','.');?></th>
				<th align="right"><?php echo $akumulasi_posisi_dana_1 < 0 ? "(".number_format($akumulasi_posisi_dana_1,0,',','.').")" : number_format($akumulasi_posisi_dana_1,0,',','.');?></th>
				<th align="right"><?php echo $posisi_dana_2 < 0 ? "(".number_format($posisi_dana_2,0,',','.').")" : number_format($posisi_dana_2,0,',','.');?></th>
				<th align="right"><?php echo $akumulasi_posisi_dana_2 < 0 ? "(".number_format($akumulasi_posisi_dana_2,0,',','.').")" : number_format($akumulasi_posisi_dana_2,0,',','.');?></th>
				<th align="right"><?php echo $posisi_dana_3 < 0 ? "(".number_format($posisi_dana_3,0,',','.').")" : number_format($posisi_dana_3,0,',','.');?></th>
				<th align="right"><?php echo $akumulasi_posisi_dana_3 < 0 ? "(".number_format($akumulasi_posisi_dana_3,0,',','.').")" : number_format($akumulasi_posisi_dana_3,0,',','.');?></th>
				<th align="right"><?php echo $posisi_dana_4 < 0 ? "(".number_format($posisi_dana_4,0,',','.').")" : number_format($posisi_dana_4,0,',','.');?></th>
				<th align="right"><?php echo $akumulasi_posisi_dana_4 < 0 ? "(".number_format($akumulasi_posisi_dana_4,0,',','.').")" : number_format($akumulasi_posisi_dana_4,0,',','.');?></th>
				<th align="right"><?php echo $posisi_dana_5 < 0 ? "(".number_format($posisi_dana_5,0,',','.').")" : number_format($posisi_dana_5,0,',','.');?></th>
				<th align="right"><?php echo $akumulasi_posisi_dana_5 < 0 ? "(".number_format($akumulasi_posisi_dana_5,0,',','.').")" : number_format($akumulasi_posisi_dana_5,0,',','.');?></th>
				<th align="right"><?php echo $posisi_dana_6 < 0 ? "(".number_format($posisi_dana_6,0,',','.').")" : number_format($posisi_dana_6,0,',','.');?></th>
				<th align="right"><?php echo $akumulasi_posisi_dana_6 < 0 ? "(".number_format($akumulasi_posisi_dana_6,0,',','.').")" : number_format($akumulasi_posisi_dana_6,0,',','.');?></th>
				<th align="right"><?php echo number_format(0,0,',','.');?></th>
			</tr>
	    </table>

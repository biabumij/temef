...
<html>
	...
	<body>
		...
		<table width="98%" border="0" cellpadding="3" border="0">
			...
			<tr class="table-baris1">
				<th align="left" class="table-border-noborder-kiri">&nbsp;&nbsp;2. Pengembalian Pinjaman</th>
				<th align="right" class="table-border-noborder-tengah"><?php echo number_format($total_rap_2022_pengembalian_pinjaman_dana,0,',','.');?></th>
				<th align="right" class="table-border-noborder-tengah"><?php echo number_format($pengembalian_pinjaman_dana_now,0,',','.');?></th>
				<th align="right" class="table-border-noborder-tengah"><?php echo number_format($pengembalian_pinjaman_dana_1,0,',','.');?></th>
				<th align="right" class="table-border-noborder-tengah"><?php echo number_format($akumulasi_pengembalian_pinjaman_dana_1,0,',','.');?></th>
				<th align="right" class="table-border-noborder-tengah"><?php echo number_format($pengembalian_pinjaman_dana_2,0,',','.');?></th>
				<th align="right" class="table-border-noborder-tengah"><?php echo number_format($akumulasi_pengembalian_pinjaman_dana_2,0,',','.');?></th>
				<th align="right" class="table-border-noborder-tengah"><?php echo number_format($pengembalian_pinjaman_dana_3,0,',','.');?></th>
				<th align="right" class="table-border-noborder-tengah"><?php echo number_format($akumulasi_pengembalian_pinjaman_dana_3,0,',','.');?></th>
				<th align="right" class="table-border-noborder-tengah"><?php echo number_format($pengembalian_pinjaman_dana_4,0,',','.');?></th>
				<th align="right" class="table-border-noborder-tengah"><?php echo number_format($akumulasi_pengembalian_pinjaman_dana_4,0,',','.');?></th>
				<th align="right" class="table-border-noborder-tengah"><?php echo number_format($pengembalian_pinjaman_dana_5,0,',','.');?></th>
				<th align="right" class="table-border-noborder-tengah"><?php echo number_format($akumulasi_pengembalian_pinjaman_dana_5,0,',','.');?></th>
				<th align="right" class="table-border-noborder-tengah"><?php echo number_format($pengembalian_pinjaman_dana_6,0,',','.');?></th>
				<th align="right" class="table-border-noborder-tengah"><?php echo number_format($akumulasi_pengembalian_pinjaman_dana_6,0,',','.');?></th>
				<th align="right" class="table-border-noborder-kanan"><?php echo number_format(0,0,',','.');?></th>
			</tr>
			<tr class="table-baris1-bold">
				<th align="left" class="table-border-atas-kiri">JUMLAH PEMAKAIAN DANA</th>
				<th align="right" class="table-border-atas-tengah"><?php echo number_format($total_rap_2022_pinjaman_dana - $total_rap_2022_pengembalian_pinjaman_dana,0,',','.');?></th>
				<th align="right" class="table-border-atas-tengah"><?php echo number_format($pinjaman_dana_now - $pengembalian_pinjaman_dana_now,0,',','.');?></th>
				<th align="right" class="table-border-atas-tengah"><?php echo number_format($pinjaman_dana_1 - $pengembalian_pinjaman_dana_1,0,',','.');?></th>
				<th align="right" class="table-border-atas-tengah"><?php echo number_format($akumulasi_pinjaman_dana_1 - $akumulasi_pengembalian_pinjaman_dana_1,0,',','.');?></th>
				<th align="right" class="table-border-atas-tengah"><?php echo number_format($pinjaman_dana_2 - $pengembalian_pinjaman_dana_2,0,',','.');?></th>
				<th align="right" class="table-border-atas-tengah"><?php echo number_format($akumulasi_pinjaman_dana_2 - $akumulasi_pengembalian_pinjaman_dana_2,0,',','.');?></th>
				<th align="right" class="table-border-atas-tengah"><?php echo number_format($pinjaman_dana_3 - $pengembalian_pinjaman_dana_3,0,',','.');?></th>
				<th align="right" class="table-border-atas-tengah"><?php echo number_format($akumulasi_pinjaman_dana_3 - $akumulasi_pengembalian_pinjaman_dana_3,0,',','.');?></th>
				<th align="right" class="table-border-atas-tengah"><?php echo number_format($pinjaman_dana_4 - $pengembalian_pinjaman_dana_4,0,',','.');?></th>
				<th align="right" class="table-border-atas-tengah"><?php echo number_format($akumulasi_pinjaman_dana_4 - $akumulasi_pengembalian_pinjaman_dana_4,0,',','.');?></th>
				<th align="right" class="table-border-atas-tengah"><?php echo number_format($pinjaman_dana_5 - $pengembalian_pinjaman_dana_5,0,',','.');?></th>
				<th align="right" class="table-border-atas-tengah"><?php echo number_format($akumulasi_pinjaman_dana_5 - $akumulasi_pengembalian_pinjaman_dana_5,0,',','.');?></th>
				<th align="right" class="table-border-atas-tengah"><?php echo number_format($pinjaman_dana_6 - $pengembalian_pinjaman_dana_6,0,',','.');?></th>
				<th align="right" class="table-border-atas-tengah"><?php echo number_format($akumulasi_pinjaman_dana_6 - $akumulasi_pengembalian_pinjaman_dana_6,0,',','.');?></th>
				<th align="right" class="table-border-atas-kanan"><?php echo number_format(($total_rap_2022_pinjaman_dana - $total_pinjaman_dana_6) - ($total_rap_2022_pengembalian_pinjaman_dana - $total_pengembalian_pinjaman_dana_6),0,',','.');?></th>
			</tr>
			<tr class="table-baris1">

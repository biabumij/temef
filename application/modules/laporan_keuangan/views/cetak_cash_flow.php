	...
	<body>
		...
		<?php
			...
			<tr class="table-baris1">
				...
				<th align="right"><?php echo $sisa_biaya_persiapan < 0 ? "(".number_format($sisa_biaya_persiapan,0,',','.').")" : $sisa_biaya_persiapan;?></th>
			</tr>
			<tr class="table-total">
			...
			<tr class="table-baris1">
				...
				<th align="right"><?php echo number_format($posisi_dana_rap,0,',','.');?></th>
				<th align="right"><?php echo number_format($posisi_dana_now,0,',','.');?></th>
				<th align="right"><?php echo number_format($posisi_dana_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_posisi_dana_1,0,',','.');?></th>
				<th align="right"><?php echo number_format($posisi_dana_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_posisi_dana_2,0,',','.');?></th>
				<th align="right"><?php echo number_format($posisi_dana_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_posisi_dana_3,0,',','.');?></th>
				<th align="right"><?php echo number_format($posisi_dana_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_posisi_dana_4,0,',','.');?></th>
				<th align="right"><?php echo number_format($posisi_dana_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_posisi_dana_5,0,',','.');?></th>
				<th align="right"><?php echo number_format($posisi_dana_6,0,',','.');?></th>
				<th align="right"><?php echo number_format($akumulasi_posisi_dana_6,0,',','.');?></th>
				<th align="right"><?php echo number_format(0,0,',','.');?></th>
			</tr>
	    </table>

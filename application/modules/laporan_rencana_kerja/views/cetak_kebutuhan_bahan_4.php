		...
		?>
			<tr>
				<td align="center" width="100%">
					...
					<div style="display: block;font-weight: bold;font-size: 11px;">PERIODE : APRIL 2023</div>
				</td>
			</tr>
			<br />
			<br />
			...
			<tr class="table-baris1">
				...
				<th align="right"><?php echo number_format($apr23['harga_semen'],0,',','.');?></th>
				<th align="right"><?php echo number_format($total_volume_semen_apr23 * $apr23['harga_semen'],0,',','.');?></th>
	        </tr>
			<tr class="table-baris1">
				...
				<th align="center">Ton</th>
				<th align="right"><?php echo number_format($apr23['harga_pasir'],0,',','.');?></th>
				<th align="right"><?php echo number_format($total_volume_pasir_apr23 * $apr23['harga_pasir'],0,',','.');?></th>
	        </tr>
			<tr class="table-baris1">
				...
				<th align="center">Ton</th>
				<th align="right"><?php echo number_format($apr23['harga_batu1020'],0,',','.');?></th>
				<th align="right"><?php echo number_format($total_volume_batu1020_apr23 * $apr23['harga_batu1020'],0,',','.');?></th>
	        </tr>
			<tr class="table-baris1">
				...
				<th align="center">Ton</th>
				<th align="right"><?php echo number_format($apr23['harga_batu2030'],0,',','.');?></th>
				<th align="right"><?php echo number_format($total_volume_batu2030_apr23 * $apr23['harga_batu2030'],0,',','.');?></th>
	        </tr>
			<tr class="table-baris1">
				...
				<th align="center">Ton</th>
				<th align="right"><?php echo number_format($apr23['harga_solar'],0,',','.');?></th>
				<th align="right"><?php echo number_format($total_volume_solar_apr23 * $apr23['harga_solar'],0,',','.');?></th>
	        </tr>
			<?php
			$total = ($total_volume_semen_apr23 * $apr23['harga_semen']) + ($total_volume_pasir_apr23 * $apr23['harga_pasir']) + ($total_volume_batu1020_apr23 * $apr23['harga_batu1020']) + ($total_volume_batu2030_apr23 * $apr23['harga_batu2030']) + ($total_volume_solar_apr23 * $apr23['harga_solar']);
			?>

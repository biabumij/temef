		...
		<table width="98%" border="0" cellpadding="3" border="0">
			...
			<tr>
				<td align="center" width="100%">
					...
					<div style="display: block;font-weight: bold;font-size: 11px; text-transform: uppercase;">PERIODE : <?php echo $date_6_awal = date('F Y', strtotime('+1 days', strtotime($date_5_akhir)));?></div>
				</td>
			</tr>
			<br />
			<br />
			...
			<tr class="table-baris1">
				...
				<th align="left"><?= $this->crud_global->GetField('penerima',array('id'=>$harga_6['supplier_id_semen']),'nama');?></th>
				<th align="center"><?php echo number_format($total_volume_semen_6,2,',','.');?></th>
				<th align="center">Ton</th>
				<th align="right"><?php echo number_format($harga_6['harga_semen'],0,',','.');?></th>
				<th align="right"><?php echo number_format($total_volume_semen_6 * $harga_6['harga_semen'],0,',','.');?></th>
	        </tr>
			<tr class="table-baris1">
				<th align="center">2.</th>	
				<th align="left">Pasir</th>
				<th align="left"><?= $this->crud_global->GetField('penerima',array('id'=>$harga_6['supplier_id_pasir']),'nama');?></th>
				<th align="center"><?php echo number_format($total_volume_pasir_6,2,',','.');?></th>
				<th align="center">Ton</th>
				<th align="right"><?php echo number_format($harga_6['harga_pasir'],0,',','.');?></th>
				<th align="right"><?php echo number_format($total_volume_pasir_6 * $harga_6['harga_pasir'],0,',','.');?></th>
	        </tr>
			<tr class="table-baris1">
				<th align="center">3.</th>	
				<th align="left">Batu Split 10-20</th>
				<th align="left"><?= $this->crud_global->GetField('penerima',array('id'=>$harga_6['supplier_id_batu1020']),'nama');?></th>
				<th align="center"><?php echo number_format($total_volume_batu1020_6,2,',','.');?></th>
				<th align="center">Ton</th>
				<th align="right"><?php echo number_format($harga_6['harga_batu1020'],0,',','.');?></th>
				<th align="right"><?php echo number_format($total_volume_batu1020_6 * $harga_6['harga_batu1020'],0,',','.');?></th>
	        </tr>
			<tr class="table-baris1">
				<th align="center">4.</th>	
				<th align="left">Batu Split 20-30</th>
				<th align="left"><?= $this->crud_global->GetField('penerima',array('id'=>$harga_6['supplier_id_batu2030']),'nama');?></th>
				<th align="center"><?php echo number_format($total_volume_batu2030_6,2,',','.');?></th>
				<th align="center">Ton</th>
				<th align="right"><?php echo number_format($harga_6['harga_batu2030'],0,',','.');?></th>
				<th align="right"><?php echo number_format($total_volume_batu2030_6 * $harga_6['harga_batu2030'],0,',','.');?></th>
	        </tr>
			<tr class="table-baris1">
				<th align="center">5.</th>	
				<th align="left">BBM Solar</th>
				<th align="left"><?= $this->crud_global->GetField('penerima',array('id'=>$harga_6['supplier_id_solar']),'nama');?></th>
				<th align="center"><?php echo number_format($total_volume_solar_6,2,',','.');?></th>
				<th align="center">Litter</th>
				<th align="right"><?php echo number_format($harga_6['harga_solar'],0,',','.');?></th>
				<th align="right"><?php echo number_format($total_volume_solar_6 * $harga_6['harga_solar'],0,',','.');?></th>
	        </tr>
			<?php
			$total = ($total_volume_semen_6 * $harga_6['harga_semen']) + ($total_volume_pasir_6 * $harga_6['harga_pasir']) + ($total_volume_batu1020_6 * $harga_6['harga_batu1020']) + ($total_volume_batu2030_6 * $harga_6['harga_batu2030']) + ($total_volume_solar_6 * $harga_6['harga_solar']);
			?>

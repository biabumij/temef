		...
		?>
			<tr>
				<td align="center"  width="100%">
					...
					<div style="display: block;font-weight: bold;font-size: 11px; text-transform: uppercase;">PERIODE : <?php echo $desember;?></div>
				</td>
			</tr>
			<br />
			<br />
			...
			<tr class="table-baris1">
				...
				<th align="left"><?= $this->crud_global->GetField('penerima',array('id'=>$des['supplier_id_semen']),'nama');?></th>
				<th align="center"><?php echo number_format($total_volume_semen_des,2,',','.');?></th>
				<th align="center">Ton</th>
				<th align="center"><?php echo number_format($des['harga_semen'],2,',','.');?></th>
				<th align="right"><?php echo number_format($total_volume_semen_des * $des['harga_semen'],2,',','.');?></th>
	        </tr>
			<tr class="table-baris1">
				<th align="center">2.</th>	
				<th align="left">Pasir</th>
				<th align="left"><?= $this->crud_global->GetField('penerima',array('id'=>$des['supplier_id_pasir']),'nama');?></th>
				<th align="center"><?php echo number_format($total_volume_pasir_des,2,',','.');?></th>
				<th align="center">Ton</th>
				<th align="center"><?php echo number_format($des['harga_pasir'],2,',','.');?></th>
				<th align="right"><?php echo number_format($total_volume_pasir_des * $des['harga_pasir'],2,',','.');?></th>
	        </tr>
			<tr class="table-baris1">
				<th align="center">3.</th>	
				<th align="left">Batu Split 10-20</th>
				<th align="left"><?= $this->crud_global->GetField('penerima',array('id'=>$des['supplier_id_batu1020']),'nama');?></th>
				<th align="center"><?php echo number_format($total_volume_batu1020_des,2,',','.');?></th>
				<th align="center">Ton</th>
				<th align="center"><?php echo number_format($des['harga_batu1020'],2,',','.');?></th>
				<th align="right"><?php echo number_format($total_volume_batu1020_des * $des['harga_batu1020'],2,',','.');?></th>
	        </tr>
			<tr class="table-baris1">
				<th align="center">4.</th>	
				<th align="left">Batu Split 20-30</th>
				<th align="left"><?= $this->crud_global->GetField('penerima',array('id'=>$des['supplier_id_batu2030']),'nama');?></th>
				<th align="center"><?php echo number_format($total_volume_batu2030_des,2,',','.');?></th>
				<th align="center">Ton</th>
				<th align="center"><?php echo number_format($des['harga_batu2030'],2,',','.');?></th>
				<th align="right"><?php echo number_format($total_volume_batu2030_des * $des['harga_batu2030'],2,',','.');?></th>
	        </tr>
			<tr class="table-baris1">
				<th align="center">5.</th>	
				<th align="left">BBM Solar</th>
				<th align="left"><?= $this->crud_global->GetField('penerima',array('id'=>$des['supplier_id_solar']),'nama');?></th>
				<th align="center"><?php echo number_format($total_volume_solar_des,2,',','.');?></th>
				<th align="center">Ton</th>
				<th align="center"><?php echo number_format($des['harga_solar'],2,',','.');?></th>
				<th align="right"><?php echo number_format($total_volume_solar_des * $des['harga_solar'],2,',','.');?></th>
	        </tr>
	    </table>
	</body>
</html>
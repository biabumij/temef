            ...
            <div class="content-header">
                <div class="leftside-content-header">
                    <ul class="breadcrumbs">
                        ...
                        <li><a href="<?= base_url('produksi/data_komposisi/' . $agregat["id"]) ?>">Data Komposisi</a></li>
                ...
                <div class="col-sm-12 col-lg-12">
                    <div class="panel">
                        ...
                        <div class="panel-content">
                            <form method="POST" action="<?php echo site_url('produksi/submit_sunting_agregat');?>" id="form-po" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <tbody>
									...
									?>
                                        <tr>
											...
											<td class="text-center"><input type="text" id="presentase_a" name="presentase_a" class="form-control numberformat text-center" value="<?= $agregat['presentase_a'] ?>" onchange="changeData(1)" required="" autocomplete="off"></td>
                                            <td class="text-right"><input type="text" id="price_a" name="price_a" class="form-control text-right" value="<?= $agregat['price_a'] ?>" onchange="changeData(1)" required="" autocomplete="off"></td>
                                            <td class="text-right"><input type="text" id="total_a" name="total_a" class="form-control text-right" value="<?= $agregat['total_a'] ?>" onkeyup="sum();" required="" autocomplete="off"></td>
                                        </tr>
										<tr>
											...
											<td class="text-center"><input type="text" id="presentase_b" name="presentase_b" class="form-control numberformat text-center" value="<?= $agregat['presentase_b'] ?>" onchange="changeData(1)" required="" autocomplete="off"></td>
                                            <td class="text-right"><input type="text" id="price_b" name="price_b" class="form-control text-right" value="<?= $agregat['price_b'] ?>" onchange="changeData(1)" required="" autocomplete="off"></td>
                                            <td class="text-right"><input type="text" id="total_b" name="total_b" class="form-control text-right" value="<?= $agregat['total_b'] ?>" onkeyup="sum();" required="" autocomplete="off"></td>
                                        </tr>
										<tr>
											...
											<td class="text-center"><input type="text" id="presentase_c" name="presentase_c" class="form-control numberformat text-center" value="<?= $agregat['presentase_c'] ?>" onchange="changeData(1)" required="" autocomplete="off"></td>
                                            <td class="text-right"><input type="text" id="price_c" name="price_c" class="form-control text-right" value="<?= $agregat['price_c'] ?>" onchange="changeData(1)" required="" autocomplete="off"></td>
                                            <td class="text-right"><input type="text" id="total_c" name="total_c" class="form-control text-right" value="<?= $agregat['total_c'] ?>" onkeyup="sum();" required="" autocomplete="off"></td>
                                        </tr>
										<tr>
											...
											<td class="text-center"><input type="text" id="presentase_d" name="presentase_d" class="form-control numberformat text-center" value="<?= $agregat['presentase_d'] ?>" onchange="changeData(1)" required="" autocomplete="off"></td>
                                            <td class="text-right"><input type="text" id="price_d" name="price_d" class="form-control text-right" value="<?= $agregat['price_d'] ?>" onchange="changeData(1)" required="" autocomplete="off"></td>
                                            <td class="text-right"><input type="text" id="total_d" name="total_d" class="form-control text-right" value="<?= $agregat['total_d'] ?>" onkeyup="sum();" required="" autocomplete="off"></td>
                                        </tr>
										<tr>
											<td class="text-right" colspan="5"><b>TOTAL</b></td>
											<td class="text-right"><input type="text" id="total_all" name="total_all" class="form-control  text-right" value="" required="" readonly=""></td>
										</tr>
                                </tbody>
                                <tfoot>
                            ...
                            <div class="row">
                                <div class="col-sm-12 text-right">
                                    <a href="<?= base_url('produksi/data_komposisi/' . $agregat["id"]) ?>" class="btn btn-info" style="margin-bottom:0;"><i class="fa fa-mail-reply"></i> Kembali</a>

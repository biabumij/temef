                        ...
                        <div class="panel">
                                ...
                                <h3 class="section-subtitle">
                                    ...
                                    <div class="pull-right">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="<?= site_url('produksi/form_approval_laporan'); ?>">Approval Laporan <i>(Coming Soon)</i></a></li>
                                        </ul>
                                    </div>
                                </h3>
                            ...
                            <div class="panel-content">
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li role="presentation"><a href="#approval_laporan" aria-controls="approval_laporan" role="tab" data-toggle="tab">Approval Laporan <i>(Coming Soon)</i></a>
                                </ul>

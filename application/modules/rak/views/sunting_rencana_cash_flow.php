                                ...
                                <form method="POST" action="<?php echo site_url('rak/submit_sunting_rencana_cash_flow');?>" id="form-po" enctype="multipart/form-data" autocomplete="off">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 text-center">
                                            <a href="<?= site_url('admin/rencana_cash_flow');?>" class="btn btn-danger" style="margin-bottom:0px; width:10%; font-weight:bold; border-radius:10px;"><i class="fa fa-close"></i> Batal</a>

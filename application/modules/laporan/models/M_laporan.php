...
class M_laporan extends CI_Model {
    ...
    function showBiaya_parent($date)
    {
    ...
    function showBiayaJurnal_parent($date)
    {
    ...
    function showBiayaLainnya_parent($date)
    {
        $arr_date = explode(' - ', $date);
        $start_date = date('Y-m-d',strtotime($arr_date[0]));
        $end_date = date('Y-m-d',strtotime($arr_date[1]));
    ...
    function showBiayaLainnyaJurnal_parent($date)
    {
    ...
    function showPersiapanBiaya_parent($date)
    {
        $arr_date = explode(' - ', $date);
        $start_date = date('Y-m-d',strtotime($arr_date[0]));
        $end_date = date('Y-m-d',strtotime($arr_date[1]));
    ...
    function showPersiapanBiaya($date)
    {
        $arr_date = explode(' - ', $date);
        $start_date = date('Y-m-d',strtotime($arr_date[0]));
        $end_date = date('Y-m-d',strtotime($arr_date[1]));
    ...
    function showPersiapanJurnal_parent($date)
    {
    ...
    function showPersiapanJurnal($date)
    {
    ...
    function biaya_langsung_print_parent($date)
    {
    ...
    function biaya_langsung_jurnal_print_parent($date)
    {
    ...
    function showBiaya_print_parent($date)
    {
    ...
    function showBiayaJurnal_print_parent($date)
    {
    ...
    function showBiayaLainnya_print_parent($date)
    {
        $arr_date = explode(' - ', $date);
        $start_date = date('Y-m-d',strtotime($arr_date[0]));
        $end_date = date('Y-m-d',strtotime($arr_date[1]));
    ...
    function showBiayaLainnyaJurnal_print_parent($date)
    {
    ...
    function showPersiapanBiaya_print_parent($date)
    {
        $arr_date = explode(' - ', $date);
        $start_date = date('Y-m-d',strtotime($arr_date[0]));
        $end_date = date('Y-m-d',strtotime($arr_date[1]));
    ...
    function showPersiapanBiaya_print($date)
    {
        $arr_date = explode(' - ', $date);
        $start_date = date('Y-m-d',strtotime($arr_date[0]));
        $end_date = date('Y-m-d',strtotime($arr_date[1]));
    ...
    function showPersiapanJurnal_print_parent($date)
    {
    ...
    function showPersiapanJurnal_print($date)
    {

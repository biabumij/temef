                ...
                <div class="content-header">
                    <div class="leftside-content-header">
                        <ul class="breadcrumbs">
                            ...
                            <li>
                                <a href="<?php echo site_url('admin/komposisi');?>"> <i class="fa fa-sitemap" aria-hidden="true"></i> Komposisi</a></li>
                            <li><a>Komposisi</a></li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="col-sm-12 col-lg-12">
                        <div class="panel">
                            <div class="panel-header"> 
                                <div class="">
                                    <h3 class="">Komposisi Baru</h3>                                
                                </div>
                            </div>
                            <div class="panel-content">
                                <form method="POST" action="<?php echo site_url('komposisi/submit_agregat');?>" id="form-po" enctype="multipart/form-data" autocomplete="off">
                                    <div class="row">
										<div class="col-sm-2">
												...
												<table id="table-product" class="table table-bordered table-striped table-condensed table-center">
													...
													<tbody>
														 <tr>
															...
															<td>
																<input type="text" id="price_a" name="price_a" class="form-control text-right" value="" onchange="changeData(1)" required="" autocomplete="off">
															</td>
															<td>
																<input type="text" id="total_a" name="total_a" class="form-control text-right" value="" onkeyup="sum();" required="" autocomplete="off">
															</td>
														</tr>
														<tr>
															<td>2.</td>												

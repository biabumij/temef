                ...
                <div class="col-sm-12 col-lg-12">
                    <div class="panel">
                        ...
                        <div class="panel-content">
                            <form method="POST" action="<?php echo site_url('komposisi/submit_sunting_agregat');?>" id="form-po" enctype="multipart/form-data" autocomplete="off">
                            ...
                            <div class="row">
                                <div class="col-sm-12 text-right">
                                    <a href="<?= base_url('komposisi/data_komposisi/' . $agregat["id"]) ?>" class="btn btn-info" style="margin-bottom:0;"><i class="fa fa-mail-reply"></i> Kembali</a>

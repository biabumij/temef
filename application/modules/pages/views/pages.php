                            ...
                            <div class="tabs">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade" id="add">
                                        <form id="inline-validation" method="POST" class="form-horizontal form-stripe form-submit" novalidate="novalidate" data-button="#btn-submit" action="<?php echo site_url('pages/add');?>" data-redirect="<?php echo site_url('admin/pages');?>">

...
<div class="wrap">
                            ...
                            <div class="tabs">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade" id="add">
                                        <form id="inline-validation" method="POST" class="form-horizontal form-stripe form-submit" novalidate="novalidate" data-button="#btn-submit" action="<?php echo site_url('pages/add_pages_position');?>" data-redirect="<?php echo site_url('admin/pages_position');?>">
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 control-label">Pages Position<span class="required" aria-required="true">*</span></label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="pages_position_category" name="pages_position_category">
                                                </div>
                                            </div>
                                            <div class="form-group">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            load_table("<?php echo site_url('pages/table_pages_position');?>");
        });
    </script>

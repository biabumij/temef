                            ...
                            <div class="panel-content">
                                <form method="POST" action="<?php echo site_url('pembelian/submit_penawaran_pembelian');?>" id="form-po" enctype="multipart/form-data" autocomplete="off">
                                    ...
                                    <div class="text-center">
                                        <a href="<?php echo site_url('admin/pembelian');?>" class="btn btn-danger" style="margin-bottom:0px; width:200px; font-weight:bold;"><i class="fa fa-close"></i> Batal</a>
                                        <button type="submit" class="btn btn-success" style="width:200px; font-weight:bold;"><i class="fa fa-send"></i>  Kirim</button>
                                    </div>
                                </form>
                            </div>
                        </div>

                    ...
                    <div class="col-sm-12 col-lg-12">
                        <div class="panel">
                            ...
                            <div class="panel-content">
								<form class="form-horizontal form-new" action="<?= site_url('pmm/biaya/submit_biaya');?>" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            ...
                                            <select id="penerima"  class="form-control form-select2"  name="penerima" required="">
												...
												<?php
                                                if (!empty($penerima)) {
                                                    foreach ($penerima as $key => $sb) {
                                                ?>
                                                        <option value="<?= $sb['id']; ?>" <?= ($sb['id'] == $penerima['penerima']) ? 'selected' : '' ?>><?= $sb['nama']; ?></option>
                                                <?php
                                                    }
                                                }
                                                ?>
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <input type="text" class="form-control dtpicker" name="tanggal_transaksi" value="<?= (isset($edit)) ? $edit['tanggal_transaksi'] = date('d m Y',strtotime($edit["tanggal_transaksi"])) : '' ;?>">
                                        </div>
                                        <div class="col-sm-3">
                                            <label>Nomor Transaksi</label>
                                            <input type="text" class="form-control" name="nomor_transaksi" name="nomor_transaksi" value="<?= (isset($edit)) ? $edit['nomor_transaksi'] : '' ;?>">
                                        </div>
                                        <div class="col-sm-3">
												...
												<?php
                                                    if($pembayaran){
                                                        foreach ($pembayaran as $key => $p) {
                                                           ...
                                                           if(isset($edit) && $edit['cara_pembayaran'] == $p['id']){
                                                                $selected = 'selected';
                                                            }
                                                            ?>

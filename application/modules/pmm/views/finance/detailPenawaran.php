                    ...
                    <div class="panel">
                        <div class="panel-header">
                                <div class="text-right">
                                    <h3 class="pull-left">Detail Penawaran Penjualan</h3>
                        ...
                        <div class="panel-content">
                            <table class="table table-bordered table-striped">
                                ...
                                <tr>
                                    <th >Tanggal</th>
                                    <td>: <?= date("d-m-Y",strtotime($penawaran["tanggal"])); ?></td>
                                </tr>
                                <tr>
                                    <th >Perihal </th>
                                ...
                                <tr>
                                    <th >Total </th>
                                    <td>: <?= $this->filter->Rupiah($penawaran["total"]); ?></td>
                                </tr>
                                <tr>
                                    <th >Status</th>
                            ...
                            <?php if($penawaran["status"] === "DRAFT") : ?>
                                <form class="form-check" action="<?= base_url("pmm/finance/approvalPenawaran/".$penawaran["id"]) ?>">
                                    <button type="submit" class="btn btn-success"><i class="fa fa-check"></i> APPROVE</button>        
                                </form>
                                <form class="form-check" action="<?= base_url("pmm/finance/rejectedPenawaran/".$penawaran["id"]) ?>">
                            ...
                            if($this->session->userdata('admin_group_id') == 1 || $this->session->userdata('admin_group_id') == 5){
                                ?>
                                <form class="form-check" action="<?= base_url("pmm/finance/hapusPenawaranPenjualan/".$penawaran["id"]) ?>">

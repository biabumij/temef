                        ...
                        <div class="panel-content">
                            ...
                            <div class="text-right">
                                ...
                                if($data['status'] == 'DRAFT'){
                                    ...
                                    if($this->session->userdata('admin_group_id') == 1 || $this->session->userdata('admin_group_id') == 4 || $this->session->userdata('admin_group_id') == 5 || $this->session->userdata('admin_group_id') == 16){
                                        ?>

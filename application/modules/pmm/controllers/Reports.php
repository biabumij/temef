...
class Reports extends CI_Controller {
	...
	public function dashboard_evaluasi_bahan($arr_date)
	{
		...
		<table class="table table-bordered" width="100%">
			...
			<tr>
				<th width="5%" class="text-center" style='background-color:rgb(238,238,238); color:black'>NO.</th>
				<th class="text-center" style='background-color:rgb(238,238,238); color:black'>URAIAN</th>
				<th class="text-center" style='background-color:rgb(238,238,238); color:black'>SATUAN</th>
				<th class="text-center" style='background-color:rgb(238,238,238); color:black'>VOLUME</th>
				<th class="text-center" style='background-color:rgb(238,238,238); color:black'>NILAI</th>
	        </tr>
			<?php
	...
	public function cash_flow($arr_date)
	{
		...
		<table class="table table-bordered" width="100%">
			...
			$jumlah_presentase = $presentase_februari + $presentase_maret + $presentase_april + $presentase_mei + $presentase_juni + $presentase_juli;
			?>
			<?php
			...
			?>
			<?php
			$jumlah_biaya_bahan = $total_desember_biaya_bahan + $total_februari_biaya_bahan + $total_maret_biaya_bahan + $total_april_biaya_bahan + $total_mei_biaya_bahan + $total_juni_biaya_bahan + $total_juli_biaya_bahan;
			$sisa_biaya_bahan = $total_rap_2022_biaya_bahan - $jumlah_biaya_bahan;
			?>
			<?php
			$jumlah_biaya_alat = $total_februari_biaya_alat + $total_maret_biaya_alat + $total_april_biaya_alat + $total_mei_biaya_alat + $total_juni_biaya_alat + $total_juli_biaya_alat;
			$sisa_biaya_alat = $total_rap_2022_biaya_alat - $jumlah_biaya_alat;
			?>
			<?php
			$jumlah_biaya_bank = $total_februari_biaya_bank + $total_maret_biaya_bank + $total_april_biaya_bank + $total_mei_biaya_bank + $total_juni_biaya_bank + $total_juli_biaya_bank;
			...
			$total_pengeluaran = $jumlah_pengeluaran_februari + $jumlah_pengeluaran_maret + $jumlah_pengeluaran_april + $jumlah_pengeluaran_mei + $jumlah_pengeluaran_juni + $jumlah_pengeluaran_juli;
			$sisa_pengeluaran = $jumlah_pengeluaran - $total_pengeluaran;
			?>
			<?php
			$jumlah_biaya_overhead = $total_desember_biaya_overhead + $total_februari_biaya_overhead + $total_maret_biaya_overhead + $total_april_biaya_overhead + $total_mei_biaya_overhead + $total_juni_biaya_overhead + $total_juli_biaya_overhead;
			...
			?>
            <?php
            $total_penerimaan_penjualan = $penerimaan_penjualan_now['total'] + $penerimaan_penjualan_februari['total'] + $penerimaan_penjualan_maret['total'] + $penerimaan_penjualan_april['total'] + $penerimaan_penjualan_mei['total'] + $penerimaan_penjualan_juni['total'] + $penerimaan_penjualan_juli['total'];
            $sisa_penerimaan_penjualan = $penerimaan_penjualan_now['total'] - $total_penerimaan_penjualan;
            ?>
            <?php
            $total_pengembalian_penjualan = $pengembalian_penjualan_now['total'] + $pengembalian_penjualan_februari['total'] + $pengembalian_penjualan_maret['total'] + $pengembalian_penjualan_april['total'] + $pengembalian_penjualan_mei['total'] + $pengembalian_penjualan_juni['total'] + $pengembalian_penjualan_juli['total'];
			...
			$posisi_vi_februari = $posisi_vi_now - $jumlah_vii_februari;
	...
	public function prognosa_produksi($arr_date)
	{
		...
		<table class="table table-bordered" width="100%">
			...
			<!-- TOTAL -->
			<?php
			$total_all_produk_a = $volume_akumulasi_produk_a + $volume_februari_produk_a + $volume_maret_produk_a + $volume_april_produk_a + $volume_mei_produk_a + $volume_juni_produk_a + $volume_juli_produk_a;
			$total_all_produk_b = $volume_akumulasi_produk_b + $volume_februari_produk_b + $volume_maret_produk_b + $volume_april_produk_b + $volume_mei_produk_b + $volume_juni_produk_b + $volume_juli_produk_b;
			$total_all_produk_c = $volume_akumulasi_produk_c + $volume_februari_produk_c + $volume_maret_produk_c + $volume_april_produk_c + $volume_mei_produk_c + $volume_juni_produk_c + $volume_juli_produk_c;
			$total_all_produk_d = $volume_akumulasi_produk_d + $volume_februari_produk_d + $volume_maret_produk_d + $volume_april_produk_d + $volume_mei_produk_d + $volume_juni_produk_d + $volume_juli_produk_d;

			$total_all_volume = $total_akumulasi_volume + $total_februari_volume + $total_maret_volume + $total_april_volume + $total_mei_volume + $total_juni_volume + $total_juli_volume;
			$total_all_nilai = $total_akumulasi_nilai +  + $total_februari_nilai +  + $total_maret_nilai + $total_april_nilai + $total_mei_nilai + $total_juni_nilai + $total_juli_nilai;

			$total_all_biaya_bahan = $total_bahan_akumulasi + $total_februari_biaya_bahan + $total_maret_biaya_bahan + $total_april_biaya_bahan + $total_mei_biaya_bahan + $total_juni_biaya_bahan + $total_juli_biaya_bahan;
			$total_all_biaya_alat = $total_alat_akumulasi + $total_februari_biaya_alat + $total_maret_biaya_alat + $total_april_biaya_alat + $total_mei_biaya_alat + $total_juni_biaya_alat + $total_juli_biaya_alat;
			$total_all_biaya_overhead = $total_overhead_akumulasi + $total_februari_biaya_overhead + $total_maret_biaya_overhead + $total_april_biaya_overhead + $total_mei_biaya_overhead + $total_juni_biaya_overhead + $total_juli_biaya_overhead;
			$total_all_biaya_bank = $total_diskonto_akumulasi + $total_februari_biaya_bank + $total_maret_biaya_bank + $total_april_biaya_bank + $total_mei_biaya_bank + $total_juni_biaya_bank + $total_juli_biaya_bank;
			...
			<tr class="table-active2-rak">
				<th class="text-left" colspan="12">RENCANA PRODUKSI & PENDAPATAN USAHA</th>
			</tr>
			...
			<tr class="table-active2-rak">
				<th class="text-left" colspan="12">BIAYA</th>
			</tr>
			<tr class="table-active3-rak">
				<th class="text-center">1</th>
				<th class="text-left">Bahan</th>

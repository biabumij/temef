	...
	public function prognosa_produksi($arr_date)
	{
		...
		<table class="table table-bordered" width="100%">
			...
			<tr class="table-active3-rak">
				...
				<th class="text-right"><?php echo number_format($total_1_biaya_overhead,0,',','.');?></th>
				<th class="text-right"><?php echo number_format($total_2_biaya_overhead,0,',','.');?></th>
				<th class="text-right"><?php echo number_format($total_3_biaya_overhead,0,',','.');?></th>
				<th class="text-right"><?php echo number_format($total_4_biaya_overhead,0,',','.');?></th>
				<th class="text-right"><?php echo number_format($total_5_biaya_overhead,0,',','.');?></th>
				<th class="text-right"><?php echo number_format($total_6_biaya_overhead,0,',','.');?></th>
			...
			<tr class="table-active3-rak">
				...
				<th class="text-right"><?php echo number_format($total_1_biaya_bank,0,',','.');?></th>
				<th class="text-right"><?php echo number_format($total_2_biaya_bank,0,',','.');?></th>
				<th class="text-right"><?php echo number_format($total_3_biaya_bank,0,',','.');?></th>
				<th class="text-right"><?php echo number_format($total_4_biaya_bank,0,',','.');?></th>
				<th class="text-right"><?php echo number_format($total_5_biaya_bank,0,',','.');?></th>
				<th class="text-right"><?php echo number_format($total_6_biaya_bank,0,',','.');?></th>
	...
	public function rencana_kerja($arr_date)
	{
		...
		<table class="table table-bordered" width="100%">
			...
			<tr class="table-total">
				...
				<th class="text-right"><a target="_blank" href="<?= base_url("laporan/cetak_kebutuhan_bahan_1") ?>"><?php echo number_format($total_1_volume,2,',','.');?></a></th>
				<th class="text-right"><a target="_blank" href="<?= base_url("laporan/cetak_kebutuhan_bahan_2") ?>"><?php echo number_format($total_2_volume,2,',','.');?></a></th>
				<th class="text-right"><a target="_blank" href="<?= base_url("laporan/cetak_kebutuhan_bahan_3") ?>"><?php echo number_format($total_3_volume,2,',','.');?></a></th>
				<th class="text-right"><a target="_blank" href="<?= base_url("laporan/cetak_kebutuhan_bahan_4") ?>"><?php echo number_format($total_4_volume,2,',','.');?></a></th>
				<th class="text-right"><a target="_blank" href="<?= base_url("laporan/cetak_kebutuhan_bahan_5") ?>"><?php echo number_format($total_5_volume,2,',','.');?></a></th>
				<th class="text-right"><a target="_blank" href="<?= base_url("laporan/cetak_kebutuhan_bahan_6") ?>"><?php echo number_format($total_6_volume,2,',','.');?></a></th>
			</tr>
			<tr class="table-total">

...
class Reports extends CI_Controller {
	...
	public function table_evaluasi_alat($arr_date)
	{
		...
		<table class="table table-bordered" width="100%">
			...
			$vol_batching_plant = $total_vol_batching_plant;
			$vol_truck_mixer = $total_vol_truck_mixer;
			$vol_wheel_loader = $total_vol_wheel_loader;
			$vol_bbm_solar = $total_vol_bbm_solar;

			$batching_plant = $total_batching_plant;
			$truck_mixer = $total_truck_mixer;
			$wheel_loader = $total_wheel_loader;
			$bbm_solar = $total_bbm_solar;
			...
			foreach ($pembelian_batching_plant as $x){
				$total_vol_batching_plant += $x['volume'];
			...
			foreach ($pembelian_wheel_loader as $x){
				$total_vol_wheel_loader += $x['volume'];

            ...
            <div class="content-header">
                <div class="leftside-content-header">
                    <ul class="breadcrumbs">
                        <li><i class="fa fa-home" aria-hidden="true"></i><a href="#">Wemen Competition</a></li>
                    </ul>
                </div>
            </div>
                ...
                <div class="col-sm-12 col-lg-12">
                    <div class="panel">
                        <div class="panel-header">
                            <h3 class="section-subtitle">Women Registration</h3>
                        </div>
    ...
    <script type="text/javascript">
        ...
        var table = $('#guest-table').DataTable( {
            ajax: {
                processing: true,
                serverSide: true,
                url: '<?php echo site_url('best_admin/guest_table/2');?>',
                type : 'POST',
                data: function ( d ) {
                    d.date = $('#date').val();
                }
